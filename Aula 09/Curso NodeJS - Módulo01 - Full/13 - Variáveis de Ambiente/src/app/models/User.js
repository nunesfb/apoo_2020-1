    ...
    super.init(
      {
        ...
        // armazena o caminho que o arquivo foi armazenado
        avatar_image: Sequelize.STRING,
        url: {
          // campo virtual para retornar a url da imagem
          // alem disso preciso linkar isto com o uso de um middleware
          // que esta no arquivo app.js
          type: Sequelize.VIRTUAL,
          get() {
            return `${process.env.APP_URL}/avatar/${this.avatar_image}`;
          },
        },
      },
      {
